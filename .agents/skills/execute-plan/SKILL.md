...
## Initialize
1. Read the user-provided planning document and ensure it meets the structural and content requirements defined in the `planning-doc` skill. If the user does not provide a planning doc, ask them to create one using the `/create-planning-doc` skill before proceeding.
